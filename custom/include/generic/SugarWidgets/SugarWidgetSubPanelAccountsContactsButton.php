...
class SugarWidgetSubPanelAccountsContactsButton extends SugarWidgetField
{
    ...
    public function displayList(&$layout_def)
    {
        ...
        $query = "SELECT accounts_contacts.id FROM accounts_contacts ".
        ...
        write_to_log(array($href), 'Account Name');
