...
class ContactAccountRelationship extends SugarBean
{
    // Stored fields
    public $id;
    public $contact_id;
    ...
    public $table_name = "accounts_contacts";
    public $object_name = "ContactAccountRelationship";
    ...
    public $field_defs = array(
      ...
      , 'company'=>array('name' =>'company', 'type' =>'char')
     ...
     */
    // public function ContactAccountRelationship()
    // {
    ...
    public function fill_in_additional_detail_fields()
    {
        ...
        if (isset($this->account_id) && $this->account_id != "") {
            ...
            if ($row != null) {
                ...
                write_to_log(array($row['name']), 'Account Name');
            }
        }
    }
}
